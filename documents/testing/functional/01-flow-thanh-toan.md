...
### TC-PAY-01: VIP chon muc phi + thong tin CK hien thi dung
1. Login VIP -> vao /gia-han
...
### TC-PAY-03: Admin thay payment ngay sau khi VIP submit
1. Login Admin -> vao /admin/thanh-toan
2. **Kiem tra**: Payment cua VIP xuat hien trong danh sach pending
3. **Kiem tra**: Hien thi: ten VIP, so tien, noi dung CK, thoi gian "X phut truoc"
...
### TC-PAY-05: Admin tu choi -> email VIP nhan ly do
...
### TC-PAY-07: Email xac nhan gui den VIP
