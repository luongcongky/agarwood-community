...
- Hoi vien A: nguyen.van.a@tramhuong-hn.vn / 123456
- Hoi vien B: tran.thi.b@tramhuong-hcm.vn / 123456
- Admin: admin@hoi-tram-huong.vn / 123456

## Kich ban

### TC-AUTH-01: Khach (chua login) truy cap trang Hoi vien -> redirect login
...
5. Truy cap /feed/tao-bai (Phase 2: LOGGED_IN_PREFIXES — can login nhung khong can Hoi vien)
...
### TC-AUTH-03: Hoi vien truy cap trang Admin -> redirect ve /
1. Login Hoi vien -> truy cap /admin
...
### TC-AUTH-04: Hoi vien A xem profile DN cua Hoi vien B
1. Login Hoi vien A -> truy cap /doanh-nghiep/tram-huong-sai-gon (DN cua B)
...
### TC-AUTH-05: Hoi vien A co sua thong tin cong ty B qua API
1. Login Hoi vien A
...
### TC-AUTH-06: Hoi vien A co sua SP cua Hoi vien B qua API
1. Login Hoi vien A
2. Goi Server Action updateProduct voi productId cua SP thuoc cong ty B
3. **Kiem tra**: Tra ve loi "Khong co quyen chinh sua" (403)

### TC-AUTH-07: Membership Hoi vien het han -> bi vo hieu hoa quyen Hoi vien
1. Login Hoi vien co membership het han
2. Truy cap /feed -> **Kiem tra**: Feed hien thi binh thuong
3. Truy cap /feed/tao-bai (Phase 2: LOGGED_IN — Hoi vien het han van post duoc nhu GUEST)
...
### TC-AUTH-08: Account isActive=false (Hoi vien/ADMIN bi disable) -> login bi block
1. Admin vo hieu hoa tai khoan Hoi vien (toggle isActive = false)
2. Hoi vien co dang nhap voi mat khau dung
3. **Kiem tra**: Login that bai voi thong bao "Email hoac mat khau khong chinh xac"
4. **Kiem tra**: KHONG redirect duoc vao bat ky trang Hoi vien nao
...
3. Login Hoi vien -> truy cap /login
...
### TC-AUTH-11: Hoi vien INDIVIDUAL khong thay menu DN/SP/CN
1. Login Hoi vien loai INDIVIDUAL
2. **Kiem tra**: Menu KHONG co "Doanh nghiep", "Chung nhan SP"
3. **Kiem tra**: Menu CO "Tong quan", "Bang tin", "Tai lieu", "Gia han", "Ho so"

### TC-AUTH-12: Hoi vien INDIVIDUAL khong truy cap duoc trang DN
1. Login Hoi vien INDIVIDUAL -> truy cap /doanh-nghiep-cua-toi
2. **Kiem tra**: Hien "Chua co thong tin doanh nghiep"
3. Truy cap /san-pham/tao-moi
4. **Kiem tra**: Hien "Ban chua co doanh nghiep"

### TC-AUTH-13: Hoi vien INDIVIDUAL khong nop don chung nhan duoc
1. Login Hoi vien INDIVIDUAL -> truy cap /chung-nhan/nop-don
2. **Kiem tra**: Dropdown san pham trong (khong co SP vi khong co DN)

### TC-AUTH-14: Hoi vien INDIVIDUAL van dang bai feed duoc
1. Login Hoi vien INDIVIDUAL -> /feed/tao-bai
2. Nhap noi dung -> Dang bai
3. **Kiem tra**: Bai xuat hien tren feed voi label "Chuyen gia"

### TC-AUTH-15: Hoi vien BUSINESS van thay day du menu
1. Login Hoi vien loai BUSINESS
...
1. Truy cap /login -> click "Dang nhap bang Google"
2. Chon tai khoan Google co email trung voi Hoi vien da active trong DB
