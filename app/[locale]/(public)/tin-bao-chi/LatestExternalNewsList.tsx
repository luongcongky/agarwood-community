...
import { loadMoreExternalNews, type ExternalNewsListItem } from "./actions"

type Props = {
  initialItems: ExternalNewsListItem[]
...
export function LatestExternalNewsList({
  initialItems,
  initialHasMore,
  locale,
  q,
  ...
  const [items, setItems] = useState<ExternalNewsListItem[]>(initialItems)
