...
import { loadMoreResearch, type ResearchListItem } from "./actions"
...
/**
 * Cùng pattern với LatestNewsList của tin-tuc: IntersectionObserver với
 * rootMargin 200px → fetch thêm 10 items trước khi user chạm đáy.
 */
export function LatestResearchList({
  initialItems,
  initialHasMore,
  locale,
  q,
