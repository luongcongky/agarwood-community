...
async function main() {
  ...
  await prisma.siteConfig.createMany({
    ...
    data: [
      ...
      { key: "banner_quota_guest",     value: "1",       description: "Quota banner / tháng — Tài khoản cơ bản" },
      { key: "banner_quota_vip_1",     value: "5",       description: "Quota banner / tháng — Hội viên ★" },
      { key: "banner_quota_vip_2",     value: "10",      description: "Quota banner / tháng — Hội viên ★★ Bạc" },
      { key: "banner_quota_vip_3",     value: "20",      description: "Quota banner / tháng — Hội viên ★★★ Vàng" },
      { key: "product_quota_guest_monthly",  value: "3",   description: "Quota sản phẩm / tháng — Tài khoản cơ bản" },
      { key: "product_quota_vip_1_monthly",  value: "10",  description: "Quota sản phẩm / tháng — Hội viên ★" },
      { key: "product_quota_vip_2_monthly",  value: "25",  description: "Quota sản phẩm / tháng — Hội viên ★★ Bạc" },
      { key: "product_quota_vip_3_monthly",  value: "-1",  description: "Quota sản phẩm / tháng — Hội viên ★★★ Vàng (unlimited)" },
    ],
  })
